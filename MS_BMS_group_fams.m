function MS_BMS_group_fams(BMS, mods, fams) % Release cvBMS
% _
% Family Inference for Group-Level Bayesian Model Selection
% FORMAT MS_BMS_group_fams(BMS, mods, fams)
...
% 
% FORMAT MS_BMS_group_fams(BMS, mods, fams) generates alpha maps for
% family inference. This procedure exploits the agglomerative property of
% the Dirichlet distribution [1] by summing Dirichlet-distributed random
...
% 
% Further information:
%     help MS_BMS_group_mods
% 
% Exemplary usage:
%     MS_BMS_group_fams(BMS, [1 1 1 2 2], {'Fam_A' 'Fam_B'});
% 
% References:
...
% Init progress bar
%-------------------------------------------------------------------------%
Finter = spm('FigName','MS_BMS_group_fams: load');
...
% Init progress bar
%-------------------------------------------------------------------------%
Finter = spm('FigName','MS_BMS_group_fams: estimate');
...
% Init progress bar
%-------------------------------------------------------------------------%
Finter = spm('FigName','MS_BMS_group_fams: save');
