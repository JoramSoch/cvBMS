function MA_LFE_uniform(LMEs, mods, fams, folder) % Release cvBMS
% _
...
%  Last edit: 15/09/2016, 07:25 (V0.9a/V13a)
...
%-------------------------------------------------------------------------%
for i = 1:F
    LFE_dir   = strcat(folder,'/',fams{i},'/');
    mkdir(LFE_dir); cd(LFE_dir);
    H.fname   = 'MA_LFE_uniform.nii';
